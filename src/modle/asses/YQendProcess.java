        ...
        try {
            ...
            while ((allAssess.next())) {// Get All Activ Assessment
                ...
                if (over >= ((quater * 4) - (dis10 * 4))) {
                    ...
                    saveQstart(1, stringDate, idAssessment, currentYear, modle.Maths.round2(arriars + lya), modle.Maths.round2(warrant + lyw), modle.Maths.round2(havetopay), modle.Maths.round2(q4warrant), 0, 0, 0, 0, 0, 0, 0, "Year Start Process", modle.Maths.round2(arriars), modle.Maths.round2(warrant));
